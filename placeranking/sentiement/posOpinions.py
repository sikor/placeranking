...
"""in a normal screen process , these bromides would be barely enough to sustain an interstitial program on the discovery channel . but in imax 3-d , the clich�s disappear into the vertiginous perspectives opened up by the photography . """,
...
"""m�nch's genuine insight makes the film's occasional overindulgence forgivable . """,
...
"""as a randy film about sexy people in gorgeous places being pushed and pulled ( literally and figuratively ) by desire . . . [sex and luc�a] makes for an arousing good time . """,
...
"""complex , affecting and uniquely almod�var , the film evokes strong emotions and pushes viewers to question their deepest notions of moral right and wrong . """,
...
"""there's an energy to y tu mam� tambi�n . much of it comes from the brave , uninhibited performances by its lead actors . """,
...
"""m�s sarc�stica , divertida y demencial que su predecesora , es un buen ejemplo de lo que es el cine de entretenimiento puro y sin complejos . """,
...
"""occasionally funny , always very colorful and enjoyably overblown in the traditional almod�var style . """,
...
"""uno de los policiales m�s interesantes de los �ltimos tiempos . """,
...
"""[n�s] directed the stage version of elling , and gets fine performances from his two leads who originated the characters on stage . """,
...
"""ao sair do cinema , eu estava feliz e com saudades de um tempo em que , para mim , a exist�ncia de papai noel era um fato inquestion�vel . """,
...
"""garc�a bernal and talanc�n are an immensely appealing couple , and even though their story is predictable , you'll want things to work out . """,
...
"""contando com uma premissa curiosa , o filme mergulha o espectador em um clima de forte suspense , culminando em um desfecho que certamente fica na mem�ria . """,
...
"""sch�tte's dramatic snapshot of the artist three days before his death offers an interesting bit of speculation as to the issues brecht faced as his life drew to a close . """,
...
"""en s� mismo el rey le�n es un espect�culo digno de contemplarse en cine , dvd o en su soberbio montaje teatral ; pero el hacerlo en la pantalla imax es una experiencia colosal . """,
...
"""os universos de chuck barris e charlie kaufman s�o complementares . e igualmente fascinantes . """,
...
"""gra�as �s intera��es entre seus personagens , o filme torna-se n�o apenas uma hist�ria divertida sobre uma curiosa persegui��o , mas tamb�m um belo estudo de personagens . """,
...
"""thanks to the ch�teau's balance of whimsicality , narrative discipline and serious improvisation , almost every relationship and personality in the film yields surprises . """,
...
"""the fluid motion is astounding on any number of levels -- including the physical demands made on b�ttner -- and it implies in its wake the intractable , irreversible flow of history . """,
...
"""while guzm�n frustratingly refuses to give pinochet's crimes a political context , his distance from the material is mostly admirable . """,
...
"""'divertida , enternecedora , universal y profundamente sincera , es una de las mejores comedias rom�nticas en mucho tiempo . una verdadera delicia . '""",
...
"""a fascinating glimpse into an insular world that gives the lie to many clich�s and showcases a group of dedicated artists . """,
...
"""el peso de un l�quido incoloro , el peso del l�quido vital , del amor como elemento de vida , y de muerte . . . """,
...
"""lejos del para�so es al mismo tiempo una fiesta para los ojos y o�dos y un movilizador cuadro de personajes enfrentados a sus propios deseos , miedos y prejuicios . """,
...
"""el t�tulo no enga�a : la pel�cula narra una historia donde una mujer enfrentar� cierta realidad , y donde el sexo es . . . """,
"""offers a persuasive look at a defeated but defiant nation in flux . """,
"""'interesante y disfrutable trabajo gracias a que prescinde del cl�sico elemento estadounidense patriotero y manipulador . '""",
...
"""para hitler , o mundo era sua tela ; e o horror , seu pincel . e max retrata este fato com elegante abandono , numa triste constata��o da realidade hist�rica . """,
...
"""chicago pode at� ser um filme divertido e cativante ( como � ) , mas acaba representando um passo que vai na dire��o contr�ria � evolu��o dos musicais . """,
...
"""'estupendamente actuada , sumamente emotiva y profundamente humana , es una experiencia f�lmica imposible de olvidar'""",
...
"""heartwarming here relies less on forced air than on petter n�ss' delicate , clever direction . . . and a wonderful , imaginative script by axel hellstenius . """,
...
"""o �ltimo suspeito ganha for�a ao tamb�m funcionar em uma esfera adicional : a do drama familiar . """,
...
""" . . . somehow manages to escape the shackles of its own clich�s to be the best espionage picture to come out in weeks . """,
...
"""allen se atreve a atacar , a atacarse y nos ofrece gags que van de la sonrisa a la risa de larga duraci�n""",
...
"""una pel�cula oscura , precisa , por momentos grandiosa y casi siempre conmovedora . """,
...
"""os problemas t�m in�cio a partir do momento em que sa�mos do cinema e come�amos a pensar sobre o que acabamos de ver . � ent�o que sinais realmente desaponta . """,
...
"""sem se preocupar em criar momentos melodram�ticos para arrancar l�grimas do espectador , o pianista � um filme triste sem que , para isso , precise ser emocionante . """,
...
"""'aunque recurre a ciertos clich�s del g�nero , la poderosa actuaci�n de robin williams perdona las fallas del gui�n . '""",
...
"""bon app�tit ! just like a splendid meal , red dragon satisfies � from its ripe recipe , inspiring ingredients , certified cuisine and palatable presentation . """,
...
"""like mike is a harmlessly na�ve slice of b-ball fantasy , fit for filling in during the real nba's off-season . """,
...
"""y tu mam� tambi�n es un buen filme gracias a lo poco convencional de su narrativa , y es quiz� el proyecto m�s arriesgado en la carrera de alfonso cuar�n""",
...
"""� uma pena que , mais tarde , o pr�prio filme abandone o tom de par�dia e passe a utilizar os mesmos clich�s que havia satirizado . """,
...
"""an enjoyable comedy of lingual and cultural differences� the ch�teau is a film -- full of life and small delights -- that has all the wiggling energy of young kitten . """,
...
"""es una de esas pel�culas de las que uno sale reconfortado , agradecido , genuinamente sorprendido . """,
...
"""to some eyes this will seem like a recycling of clich�s , an assassin's greatest hits . to others , it will remind them that hong kong action cinema is still alive and kicking . """,
"""gran historia sobre el amor , la familia , la lealtad y la traici�n que seguramente se convertir� en un nuevo cl�sico del g�nero . """,
...
"""berling and b�art . . . continue to impress , and isabelle huppert . . . again shows uncanny skill in getting under the skin of her characters . """,
...
"""[cuar�n has] created a substantive movie out of several cliched movie structures : the road movie , the coming-of-age movie , and the teenage sex comedy . """,
...
""" . . . planos fijos , tomas largas , un ritmo pausado y una sutil observaci�n de sus personajes , sin estridencias ni grandes revelaciones . """,
