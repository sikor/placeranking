...
"""pascale bailly's rom-com provides am�lie's audrey tautou with another fabuleux destin -- i . e . , a banal spiritual quest . """,
...
"""absurdities and clich�s accumulate like lint in a fat man's navel . """,
...
"""respons�vel direto pelo fracasso 'art�stico' de doce lar , o roteirista c . jay cox n�o consegue sequer aproveitar os pouqu�ssimos momentos em que escapa da mediocridade . """,
...
"""brady achieves the remarkable feat of squandering a topnotch foursome of actors . . . by shoving them into every clich�d white-trash situation imaginable . """,
...
"""no dia em que aceitou dirigir esta continua��o , harold ramis deve ter sa�do da cama com o p� esquerdo . e aqueles que decidiram assistir a este filme tamb�m . """,
...
"""'the ch�teau is never quite able to overcome the cultural moat surrounding its ludicrous and contrived plot . '""",
...
"""howard conjures the past via surrealist flourishes so overwrought you'd swear he just stepped out of a bu�uel retrospective . """,
...
"""an overstylized , pur�ed m�lange of sex , psychology , drugs and philosophy . sometimes entertaining , sometimes indulgent -- but never less than pure wankery . """,
...
"""buries an interesting storyline about morality and the choices we make underneath such a mountain of clich�s and borrowed images that it might more accurately be titled mr . chips off the old block . """,
...
"""without non-stop techno or the existential overtones of a kieslowski morality tale , maelstr�m is just another winter sleepers . """,
...
"""there's just no currency in deriding james bond for being a clich�d , doddering , misogynistic boy's club . """,
...
"""in the real world , an actor this uncharismatically beautiful would have a r�sum� loaded with credits like " girl in bar #3 . " """,
...
"""nair stuffs the film with dancing , henna , ornamentation , and group song , but her narrative clich�s and telegraphed episodes smell of old soap opera . """,
...
"""first-time director jo�o pedro rodrigues' unwillingness to define his hero's background or motivations becomes more and more frustrating as the film goes on . """,
...
"""'carente de imaginaci�n , mal dirigida , peor actuada y sin un �pice de romance , es una verdadera p�rdida de tiempo y dinero'""",
...
"""with its paint fights , motorized scooter chases and dewy-eyed sentiment , it's a pretty listless collection of kid-movie clich�s . """,
...
"""la cinta comienza intentando ser un drama , r�pidamente se transforma en una comedia y termina por ser una parodia absolutamente predecible""",
...
"""her film is like a beautiful food entr�e that isn't heated properly , so that it ends up a bit cold and relatively flavorless . """,
...
"""o �timo esfor�o do diretor acaba sendo frustrado pelo roteiro , que , depois de levar um bom tempo para colocar a trama em andamento , perde-se de vez a partir do instante em que os estranhos acontecimentos s�o explicados . """,
...
"""contrived pastiche of caper clich�s . """,
...
"""a collage of clich�s and a dim echo of allusions to other films . """,
...
"""starts out ballsy and stylish but fails to keep it up and settles into clich�s . """,
...
"""la de salma es una versi�n de frida superficial , preciosista y sin ning�n contenido . """,
...
"""an uninspired preachy and clich�d war film . """,
...
"""it jumps around with little logic or continuity , presenting backstage bytes of information that never amount to a satisfying complete picture of this particular , anciently demanding m�tier . """,
...
"""gets the look and the period trappings right , but it otherwise drowns in a sea of visual and verbal clich�s . """,
...
"""caso voc� sinta necessidade de sair da sala antes do t�rmino da proje��o , n�o se preocupe : ningu�m lhe enviar� penas simbolizando covardia . """,
...
"""after the first 10 minutes , which is worth seeing , the movie sinks into an abyss of clich�s , depression and bad alternative music . """,
...
"""'pocas ideas interesantes , un final pseudo m�stico que no corresponde al tono general del filme y que deja una sensaci�n de inconformidad que hace pensar m�s de una vez si vale la pena ir a la taquilla y reclamar el precio del boleto . '""",
...
"""the movie's messages are quite admirable , but the story is just too clich�d and too often strains credulity . """,
