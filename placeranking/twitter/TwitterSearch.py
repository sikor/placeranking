...
from placeranking.twitter.TwitterSearchOrder import TwitterSearchOrder
from placeranking.twitter.TwitterSearchException import TwitterSearchException
...
class TwitterSearch(object):
    ...
    # see https://dev.2.com/docs/error-codes-responses
    exceptions = { 
    ...
    def sentSearch(self, url):
        ...
        self.response['content'] = json.loads(content)
